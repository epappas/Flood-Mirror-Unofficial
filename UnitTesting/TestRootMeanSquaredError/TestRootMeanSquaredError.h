...
/*   www.cimne.com/flood                                                                                        */
/*                                                                                                              */
/*   T E S T   R O O T   M E A N   S Q U A R E D   E R R O R   C L A S S   H E A D E R                          */
/*                                                                                                              */
/*   Roberto Lopez                                                                                              */
...
#ifndef __TESTROOTMEANSQUAREDERROR_H__
#define __TESTROOTMEANSQUAREDERROR_H__
...
class TestRootMeanSquaredError : public UnitTesting 
{
...
public:
   ...
   explicit TestRootMeanSquaredError(void);


   // DESTRUCTOR

   virtual ~TestRootMeanSquaredError(void);
