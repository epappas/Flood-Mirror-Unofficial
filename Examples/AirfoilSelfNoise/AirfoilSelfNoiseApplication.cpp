...
int main(void)
{
   std::cout << "Flood Neural Network. Airfoil Self-Noise Application." << std::endl;	

//   srand((unsigned)time(NULL));

   // Input-target data set object
  
   InputTargetDataSet itds("../Data/NASAInputTargetDataSet.dat");
  ...
  // Quasi-Newton method object
   ...
   mu.save_linear_regression_analysis("../Data/LinearRegressionAnalysis.dat");
